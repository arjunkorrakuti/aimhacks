Aimhacks was created as a high-school project among four friends - @arjunkorrakuti, @arinb45, @MichaelTS2007, and @ArnavSinha0511. The game is originally based on Khan Academy's fork of ProcessingJS. Then using a boilerplate which converts the fork into normal processing, the game is turned into an HTML-based webpage. Aimhacks is very simple and hopes to test the players "aiming" skill in various ways. You can play the game at https://arjunkorrakuti.github.io/aimhacks. Below are some screenshots of the gameplay.
